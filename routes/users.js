...
router.put(
  "/updateUser/location/:id",
  ensureAuth,
  usersController.resetLocationDetails
);
router.put("/updateUser/bio/:id", ensureAuth, usersController.resetUserBio);
router.put(
  "/updateUser/site/:id",
  ensureAuth,
  usersController.resetSharedSiteDetails
);
router.put(
  "/changeAvatar/:id",
