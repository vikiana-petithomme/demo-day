...
>>>>>>> 9f0249577f0f44511e45cad803d892d671467398
  ...
  app.post('/createProposal', (req, res) => {
    db.collection('proposals').save(
      { 
  ...
  app.put('/profile', (req, res) => {
    db.collection('proposals')
      .findOneAndUpdate({ name: req.body.name, cost: req.body.cost, impact: req.body.impact, stakeholders: req.body.partners, blurb: req.body.blurb, description: req.body.description }, {
        $set: {
          name: req.body.name,
          cost: req.body.cost,
          impact: req.body.impact,
