    ...
    (err, existingUser) => {
      ...
      user.save((err) => {
        ...
        req.logIn(user, (err) => {
          ...
          console.log('this is user information ' + req.body.userFullName + req.body.originalPassword + req.body.userName + req.body.email)
          ...
          fetch(`https://concur.discourse.group/users.json?name=${req.body.userFullName}&email=${req.body.email}&password=${req.body.originalPassword}&username=${req.body.userName}r&active=true&approved=true`, requestOptions)
